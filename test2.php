...
require 'PHPMailer-master/class.smtp.php';
  ...
  $mail ->IsHTML(true);
   ...
   $mail ->SetFrom("$mailto");
   $mail ->Subject = "Reservation Mail For Chabahil";
   $mail ->Body = "You recieved Reservation by $mailName For Chabahil. <br>
   ...
   else
   {
       echo 'mail sent';
        ...
        window.location = "http://h2ocafeandpub.com.np/chabahil";
        </script> 
        <?php
   }
